							   ...
							   inView:(UIView*)containerView 
{
	...
	else
	{
		...
		noticeFrame.origin.x = CGRectGetMinX(statusIndicator.frame) + 5.f;
		noticeFrame.size.height = CGRectGetMaxY(achievementDetailText.frame) - CGRectGetMinY(notice.frame);
