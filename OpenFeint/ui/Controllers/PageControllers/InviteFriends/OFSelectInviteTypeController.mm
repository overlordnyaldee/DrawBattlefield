...
- (NSMutableArray*) buildTableSectionDescriptions
{
	...
	[self createCell:staticCells withType:ESelectedPersonType_FEINT_FRIEND withTitle:@"OpenFeint Friends" andIconName:@"OFSelectInviteTypeLeaf.png" andCreateSelector:@selector(inviteOpenFeintFriends)];
